...
/// Marks an entity that drag-pan can anchor the cursor to: with
/// `RtsCameraControls::lock_on_drag`, the cursor grab point is found by a
/// mesh raycast filtered to these entities. Focus terrain-following is the
/// host's job (this fork removed the crate's per-frame `follow_ground`
/// raycast).
