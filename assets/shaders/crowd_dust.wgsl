...
fn fragment(in: crowd_common::CrowdOut) -> @location(0) vec4<f32> {
    ...
    let box_min = vec3<f32>(-crowd_common::LEN_M / 2.0, crowd_common::terrain_c.z, 0.0);
    let box_max = vec3<f32>(crowd_common::LEN_M / 2.0, crowd_common::terrain_c.w, crowd_common::DEPTH_M);
    var t0 = 0.0;
    var t1 = 1e9;
    ...
    for (var i = 0; i < 5; i = i + 1) {
        ...
        let above = p.y - crowd_common::terrain_h_rel(p.xz);
